package philomagi.dddcj.modeling.planning_poker.core.domain.command.model
...
import philomagi.dddcj.modeling.planning_poker.core.test_helper.TestHelper.{UseDummyTable, UseDummyTableOwner}
